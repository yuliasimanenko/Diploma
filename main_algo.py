...
def tree_analysis(tree_nodes1, tree_nodes2) -> (int, bool):
    ...
    for id_key1, person1 in tree_nodes1.items():
        for id_key2, person2 in tree_nodes2.items():
            ...
            # print(person1.first_name + "    " + person2.first_name + str(compare_person(person1, person2)))
            # print(compare_parent(person1, person2))
...
def compare_person(person1: tr.Tree, person2: tr.Tree):
    """
    ...
    # print(person1.first_name + " " + person2.first_name + " " + str(probability))
    return probability
